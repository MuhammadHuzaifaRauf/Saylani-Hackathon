            ...
            <div className="container my-5">
              ...
              <div className="container d-flex flex-wrap">
                ...
                <div className="container d-flex flex-column justify-content-center col-12 col-lg-7 ms-auto me-auto mb-lg-5 pb-lg-5 ">
                  ...
                  <h3 className='fw-bold mb-5 pb-3 text-center'>Student Inclusion Request</h3>
                  ...
                  <div className="card py-5">
                    ...
                    <button type='submit' className='btn btn-outline-danger rounded-0 py-2 px-5' id='btn4' onClick={handleAddBook} onMouseLeave={handleArrow2} onMouseEnter={handleArrow}>Continue<BsArrowRight id='arrow' className=' d-none' /> </button>
